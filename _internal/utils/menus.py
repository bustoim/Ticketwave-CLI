...
async def olivia_rodrigo_menu(completed_signups, API_KEY, API_ENDPOINT, PROXIES):
    filepath = None
    proxies_file_path = None
    ...
    while True:
        clear_screen()
        print_banner()
        print("Olivia Rodrigo Signup Bot Configuration:")
        print(
            """
[1] - Run sign-up
...
[5] - Back to main menu
        ...
        if choice == "1":
            if not filepath:
                ...
                await upload_accounts_file_olivia(
                    filepath, completed_signups, API_KEY, API_ENDPOINT, PROXIES
                )
        elif choice == "2":
