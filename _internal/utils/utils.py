...
from utils.signup import signup_lady_gaga, signup_olivia
...
async def upload_accounts_file_olivia(
    filepath, completed_signups, API_KEY, API_ENDPOINT, PROXIES
):
    clear_screen()
    print_banner()
    ...
    print_banner()
    print(
        f"[i] Module: OLIVIA RODRIGO - Concurrent tasks: {concurrent_tasks} | Retries: {retries}"
    )
    print(" ")
